...
class ServiceRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.get(`${this.path}/getFeaturedService`, authMiddleware(['client', 'freelancer']), this.serviceController.getFeaturedService);
    ...
    this.router.post(
      `${this.path}/hireFreelancerService/:id`,
      authMiddleware(['client', 'freelancer']),
      this.serviceController.hireFreelancerService,
    );
    ...
    this.router.put(`${this.path}/approveService/:id`, authMiddleware(['client', 'freelancer']), this.serviceController.approveService);
