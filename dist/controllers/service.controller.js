  ...
  constructor() {
    ...
    this.hireFreelancerService = async (req, res, next) => {
      try {
        ...
        if (!service) throw new HttpException_1.HttpException(400, 7002, 'SERVICE_NOT_FOUND');
        const payload = {
          user_id,
    ...
    this.serviceProposal = async (req, res, next) => {
      try {
        ...
        if (!serviceData) throw new HttpException_1.HttpException(400, 7006, 'SERVICE_NOT_FOUND');
    ...
    this.makePayment = async (req, res, next) => {
      try {
        ...
        if (!serviceProposal) throw new HttpException_1.HttpException(400, 7002, 'SERVICE_PROPOSAL_NOT_FOUND');
      ...
      try {
        ...
        if (status === 'successful' || status === 'completed') {
          ...
          if (response.data.status === 'successful') {
            ...
            if (!proposal) throw new HttpException_1.HttpException(400, 7002, 'PROPOSAL_NOT_FOUND');
            ...
            const transactionData = {
              ...
              customer_id:
                (_c = (_b = response.data.customer) === null || _b === void 0 ? void 0 : _b.id.toString()) !== null && _c !== void 0
                  ? _c
                  : (_d = response.meta) === null || _d === void 0
                  ? void 0
                  : _d.consumer_id.toString(),
